...
import com.spbau.mit.kirakosian.threadPool.exceptions.TaskIsReadyAlreadyException;
    ...
    private class Task<T> implements LightFuture<T>, Runnable {
        ...
        public synchronized void run() {
            if (!ready) { // we may execute every task only one time
                ...
                throw new TaskIsReadyAlreadyException(); // should never happen, cause it is an inner method
            }
        }
    }
}
